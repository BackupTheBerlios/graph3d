...
/**
 * This class define an exception which is generated when two elements of
 * GNode(and his subclasses) or GLink(and his subclasses) are the same name
 * 
...
public class SameNameException extends GException {
	 ...
	 * 
	 * @param _name
	 *            the name which are the same for two elements.
	 */
