...
/**
 * This class define an exception when you try to read the ASCII file which define all types existing to create GNode and GLink. 
...
public class ASCIIFileNotFoundException extends GException {
	 ...
	 * @param _ASCIIFileName the path of the file which is not find
	 */
