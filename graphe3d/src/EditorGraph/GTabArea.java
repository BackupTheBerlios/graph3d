 ...
 * @version 1.0
 */
public class GTabArea extends JPanel{
	...
	/*
	 * the standard weight of all buttons
	 */
	 ...
	 * 		the GEditor owner
	 * @param _asciifile 
	 * 		the file which contains known types to load
	 */
	public GTabArea(GEditor owner, String _asciifile) {
		 ...
		 * area naming
		 */
		setBorder(new TitledBorder(new EtchedBorder(),"Sélection"));
		/*
		 * buttons creation
		 */
		...
		/*
		 * we set a tooltip text for each
		 */
		unselect.setToolTipText("enleve l'élément courant de la sélection");
		unselect_all.setToolTipText("enleve tous les éléments de la sélection");
		remove.setToolTipText("supprime l'élément courant du graphe");
		remove_all.setToolTipText("supprime tous les éléments du graphe");
		/*
		...
		attributes_list = new GAttributesList(
				...
				true);
		attributes_list.attachToNodes(editor.creationArea.button_bridge, 1);
		attributes_list.attachToNodes(editor.creationArea.button_arrow, 2);
		attributes_list.attachToBoth(unselect, 1);
		attributes_list.attachToBoth(unselect_all, 1);
		attributes_list.attachToBoth(remove, 1);
		attributes_list.attachToBoth(remove_all, 1);
		/*
		 * placement.
		 */
	...
	/**
	 * returns the whole list of selected nodes as an array.
	 * @return
	 * 		the whole list of selected nodes.
	 */
