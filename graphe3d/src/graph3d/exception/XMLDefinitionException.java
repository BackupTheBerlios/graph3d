...
/**
 * This class define an Exception which is generate when the XML file which
 * describe a graph doesn't respect the XML schema
 * 
...
public class XMLDefinitionException extends GException {
	 ...
	 * 
	 * @param _details
	 *            all details about this exception (error which appears into the
	 *            XML file)
	 */
	...
	public boolean showError() {
		...
		int result = JOptionPane.showOptionDialog(null, this.getMessage(),
				"XMLDefinitionException", JOptionPane.DEFAULT_OPTION,
